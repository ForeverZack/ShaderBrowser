...
namespace ImGui
{
    ...
    IMGUI_API bool          Checkbox(const char* strId, const char* label, bool* v);
    IMGUI_API bool          CheckboxFlags(const char* strId, const char* label, unsigned int* flags, unsigned int flags_value);
