...
另外，测试了将所有光源相关参数放入tbo中，精度似乎有些问题，暂时不这样去处理光源了。	<br>

## 2020.10.12 <br>
增加材质文件对深度测试、面剔除、模板测试和混合的支持。	<br>

## 2020.9.14 <br>
增加面剔除。后面材质解析也需要添加对应的关键字数据。	<br>

## 2020.9.1~2020.9.10 <br>
添加对深度测试、模板测试、混合的控制，还没有测试过是否有问题。后面材质解析也需要添加对应的关键字数据。	<br>
